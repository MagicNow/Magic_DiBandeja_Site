...
<script src="{{ asset('/assets/admin/js/vendor/jquery.ui.widget.js') }}"></script>
<!-- The Templates plugin is included to render the upload/download listings -->
<script src="{{ asset('/assets/admin/js/tmpl.js') }}"></script>
...
<script src="{{ asset('/assets/admin/js/jquery.iframe-transport.js') }}"></script>
<!-- The basic File Upload plugin -->
<script src="{{ asset('/assets/admin/js/jquery.fileupload.js') }}"></script>
<!-- The File Upload processing plugin -->
<script src="{{ asset('/assets/admin/js/jquery.fileupload-process.js') }}"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="{{ asset('/assets/admin/js/jquery.fileupload-image.js') }}"></script>
<script src="{{ asset('/assets/admin/js/jquery.fileupload-validate.js') }}"></script>
