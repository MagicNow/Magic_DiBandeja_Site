		...
		<div class="box-body">
			...
			<div class="row mt-3">
				...
				<div class="btn-group col-md-4" role="group">
					...
					<a href="{{ route('admin.cardapios.busca', ['search' => app('request')->input('search'), 'type' => 'ingredientes']) }}" class="col-md-4 menu-buttons-ingredients btn btn-secondary {{ app('request')->input('type') === 'ingredientes' ? 'active' : NULL }}">Ingredientes {{ app('request')->input('type') === 'ingredientes' ? '(' . $menus['total'] . ')' : NULL }}</a>
