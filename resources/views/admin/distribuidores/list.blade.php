						...
						<tr>
							<td width="60">
								<div class="table-actions">
									<a href="{{ route('admin.distribuidores.edit',$distribuidor->id) }}" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
									<a href="{{ route('admin.distribuidores.destroy', $distribuidor->id) }}" class="btn btn-danger" data-toggle="modal" data-target="#confirm-delete"><i class="glyphicon glyphicon-remove"></i></a>
								</div>
							</td>
