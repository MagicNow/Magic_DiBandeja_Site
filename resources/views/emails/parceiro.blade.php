	        ...
	        <table border="0" cellpadding="0" cellspacing="0" width="500" id="bodyTable">
				...
				<tr style="background-color: #f4f4f4;">
					<td bgcolor="#f4f4f4" style="background-color: #f4f4f4;">
						...
						<p style="margin: 0; color:#333; font: 14px Arial,'Helvetica Neue',Helvetica,sans-serif;">Endereço: <b>{{ $parceiro->endereco }}</b></p>
						<p style="margin: 0; color:#333; font: 14px Arial,'Helvetica Neue',Helvetica,sans-serif;">Número: <b>{{ $parceiro->numero }}</b></p>
						<p style="margin: 0; color:#333; font: 14px Arial,'Helvetica Neue',Helvetica,sans-serif;">Complemento: <b>{{ $parceiro->complemento }}</b></p>
