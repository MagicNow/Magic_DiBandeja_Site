...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>DiBandeja - Novo pedido para sua casa</title>
        <style>
        	body {
	        ...
	        <table border="0" cellpadding="0" cellspacing="0" width="500" id="bodyTable">
				...
				<tr style="background-color: #f4f4f4;">
					<td bgcolor="#f4f4f4" style="background-color: #f4f4f4;">
						<p style="margin: 0; color:#333; font: 14px Arial,'Helvetica Neue',Helvetica,sans-serif;">DiBandeja recebeu um novo cadastro de pessoa física, segue abaixo dados cadastrados:</p><br><br>
						@if (!empty($cliente->nome))
							<p style="margin: 0; color:#333; font: 14px Arial,'Helvetica Neue',Helvetica,sans-serif;">Nome: <b>{{ $cliente->nome }}</b></p>
						@endif
