...
<section class="content">
	...
	<div class="destaque">
		...
		<div class="content_destaque dibandeja_voce" style="display: none">
			<figure>
				<a href="#">
					<img class="image_destaque" src="assets/images/bg_01.png">
				</a>
			</figure>
			<a href="#" class="btn_escolha">Clique & Escolha</a>
		</div>
	...
	<div class="container">
		...
		<div class="tipos_dibandeja col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<ul>
				...
				<li data-tipo="dibandeja_voce" class="col-xs-12 col-sm-12 col-md-4 col-lg-4"> 
					<a href="#">
